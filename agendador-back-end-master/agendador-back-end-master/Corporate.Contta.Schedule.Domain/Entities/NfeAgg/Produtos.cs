...
namespace Corporate.Contta.Schedule.Domain.Entities.NfeAgg
{
    ...
    {      
        ...
        public bool ExigSuspensa { get; set; }
        public bool LancamentoOficio { get; set; }
        public bool IsencaoReducao { get; set; }
        public bool IsencaoReducaoCestaBasica { get; set; }
        public bool ExigSuspensaMono { get; set; }
        public bool AntEncTributacao { get; set; }
        public bool LancamentoOficioMono { get; set; }
        public bool SubTributariaMono { get; set; }
