...
import { apuracaoTransporteColumns } from '@/pages/app/Apuracao/constants';
  ...
  return (
    <Container>
      ...
      <Row gutter={[24, 25]} style={{ marginTop: 25 }}>
        <Col xs={24}>
          <SectionTitle>
            <Link to="/dashboard/transporte?operacao=Prestador">
              Prestações
            </Link>
          </SectionTitle>
          {entries.length > 0 ? (
            <Table
              columns={apuracaoTransporteColumns}
              dataSource={entries}
              pagination={false}
              size="small"
              rowKey="id"
        ...
        <Col xs={24}>
          <SectionTitle>
            <Link to="/dashboard/transporte?operacao=Aquisicao">
              Aquisições
            </Link>
          </SectionTitle>
          {outs.length > 0 ? (
