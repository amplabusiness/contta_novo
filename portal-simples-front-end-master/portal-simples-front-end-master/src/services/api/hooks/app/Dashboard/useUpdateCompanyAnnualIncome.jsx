...
import { putUpdateCompanyIncome } from '@/services/api/requests';

const SIMPLES_MAX_VALUE = 4800000;

const useUpdateCompanyAnnualIncome = () => {
  ...
  const mutation = useMutation(values => putUpdateCompanyIncome(values), {
...
export default useUpdateCompanyAnnualIncome;
